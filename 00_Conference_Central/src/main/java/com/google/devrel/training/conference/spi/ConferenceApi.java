...
public class ConferenceApi {
    ...
    public Profile saveProfile( User user, ProfileForm form) throws UnauthorizedException {
        ...
        if (user.getAuthDomain() == null) throw new UnauthorizedException("You not authorized");
        // TODO 1
    ...
    public Conference createConference(final User user, final ConferenceForm conferenceForm)
        ...
        Key<Profile> parentKey = Key.create(Profile.class, userId);

        final Key<Conference> conferenceKey = OfyService.factory().allocateId(parentKey, Conference.class);
